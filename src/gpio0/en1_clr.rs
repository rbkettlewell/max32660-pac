...
pub struct R(crate::R<EN1_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EN1_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EN1_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EN1_CLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EN1_CLR` writer"]
pub struct W(crate::W<EN1_CLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EN1_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EN1_CLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EN1_CLR_SPEC>) -> Self {
        W(writer)
    }
}
