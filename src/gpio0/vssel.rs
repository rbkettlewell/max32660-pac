...
pub struct R(crate::R<VSSEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<VSSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<VSSEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<VSSEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `VSSEL` writer"]
pub struct W(crate::W<VSSEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<VSSEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<VSSEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<VSSEL_SPEC>) -> Self {
        W(writer)
    }
}
