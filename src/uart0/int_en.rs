...
#[doc = "Field `CTS_CHANGE` reader - Enable for CTS signal change interrupt."]
...
#[doc = "Field `CTS_CHANGE` writer - Enable for CTS signal change interrupt."]
...
#[doc = "Field `RX_FIFO_THRESH` reader - Enable for interrupt when RX FIFO reaches the number of bytes configured by the RXTHD field."]
...
#[doc = "Field `RX_FIFO_THRESH` writer - Enable for interrupt when RX FIFO reaches the number of bytes configured by the RXTHD field."]
...
#[doc = "Field `TX_FIFO_ALMOST_EMPTY` reader - Enable for interrupt when TX FIFO has only one byte remaining."]
...
#[doc = "Field `TX_FIFO_ALMOST_EMPTY` writer - Enable for interrupt when TX FIFO has only one byte remaining."]
...
#[doc = "Field `TX_FIFO_THRESH` reader - Enable for interrupt when TX FIFO reaches the number of bytes configured by the TXTHD field."]
...
#[doc = "Field `TX_FIFO_THRESH` writer - Enable for interrupt when TX FIFO reaches the number of bytes configured by the TXTHD field."]
...
#[doc = "Field `RX_TIMEOUT` reader - Enable for RX Timeout Interrupt. Trigger if there is no RX communication during n UART characters (n=UART_CN.RXTO)."]
...
#[doc = "Field `RX_TIMEOUT` writer - Enable for RX Timeout Interrupt. Trigger if there is no RX communication during n UART characters (n=UART_CN.RXTO)."]
